      ...
      <section className="w-screen bg-[#ffa498]">
        ...
        <div className="w-screen flex">
          <div className="w-1/2">
            ...
            <div className="w-[762px] pl-[120px] space-y-2">
              <p className="w-[611px]">
          ...
          <div className="w-1/2 flex flex-wrap justify-end px-[75px] pb-20">
            <Card>
