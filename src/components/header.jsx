    ...
    return(
        <header className="w-screen h-20 bg-transparent flex">
            <Link href="/" className="w-1/4 md:relative md:pl-[68px]">
                <Image src="/auto_mail_logo1.png" alt="logo" width={118} height={68} className="md:hidden"/>
                <Image src="/auto_mail_logo1.png" alt="logo" width={148} height={98} className="hidden md:flex md:absolute"/>
            </Link>
